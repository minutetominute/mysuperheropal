...
(function() { this.JST || (this.JST = {}); this.JST["exercises/exercise-item"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<li class="exercise-item">\n\t<hgroup>\n\t\t<strong class="name">',  model.escape("name") ,' </strong>\n\t\t<strong class="calories-burned">',  model.escape("calories_burned") ,' calories</strong>\n\t</hgroup>\n</li>\t\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["exercises/form"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["exercises/index"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<section class="exercisess container">\n\t<h2>\n\t\tExercise\n\t</h2>\n\t<ul class="exercises-list">\n\t</ul>\n</section>\n\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["exercises/show"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["foods/food-item"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<li class="food-item">\n\t<hgroup>\n\t\t<strong class="name">',  model.escape("name") ,' </strong>\n\t\t<strong class="radiation">',  model.escape("radiation") ,' mrem</strong>\n\t</hgroup>\n</li>\t\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["foods/form"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["foods/index"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<section class="foods container">\n\t<h2>\n\t\tFoods\n\t</h2>\n\t<ul class="foods-list">\n\t</ul>\n</section>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["foods/show"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["home"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<section class="container animation-fadein">\n  <h1>\n    Welcome back ',  Mysuperheropal.currentUser.escape("superhero_name") ,'!\n  </h1>\n  <section class="user-views">\n\n  </section>\n</section>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["layouts/new_session_header"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<nav class="group">\n  <a href="#signup" class="sign-up">Sign up</a>\n</nav>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["layouts/new_user_header"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<nav class="group">\n  <a href="#login" class="login">Login</a>\n</nav>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["layouts/signed_in_header"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<a class="icon" href="">',  mysuperheropalicon ,'<a>\n<form action="api/search" method="get">\n\t<input class="search" name="query" placeholder="Search for foods and exercises">\n</form>\n<nav class="group">\n\t<a href="#foods" class="foods">Foods</a>\n\t<a href="#exercises" class="exercises">Exercises</a>\n\t<a href="#logout" class="logout">Logout</a>\n</nav>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["session/new"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<section class="container animation-fadein">\n  ',  mysuperheropallogo ,'\n  <form class="login">\n\n    <label></label>\n      <input class="email" type="text" name="user[email]" value="" placeholder="Email">\n\n    <label></label>\n      <input class="password" type="password" name="user[password]" value="" placeholder="Password">\n\n\t\t<button>Login</button>\n\t</form>\n\t<button class="demo-user" data-email="thehulk@gmail.com" data-password="123456">Login as The Hulk!</button>\n</section>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["ui_elements/dashboard_widget"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<section class="dashboard-widget">\n  <hgroup>\n    <h2>\n      Your Daily Summary\n    </h2>\n  </hgroup>\n\n  <section class="content">\n    <figure></figure>\n    <h3>\n      <strong class="rad-count">2500</strong> mrem remaining\n    </h3>\n  </section>\n</section>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["ui_elements/news_feed"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<section class="news-feed">\n  <hgroup>\n    <h2>\n      News Feed\n    </h2>\n  </hgroup>\n</section>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["users/new"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<section class="container animation-fadein">\n  ',  mysuperheropallogo ,'\n  <form class="signup" action="" method="post">\n\n    <label></label>\n      <input type="text" name="user[email]" value="" placeholder="Email">\n\n    <label></label>\n      <input type="text" name="user[superhero_name]" value="" placeholder="Superhero name">\n\n    <label></label>\n      <input type="password" name="user[password]" value="" placeholder="Password">\n\n    <button>Sign up!</button>\n  </form>\n</section>\n');}return __p.join('');};
}).call(this);
